...
$positionId=(int)($_REQUEST['position_id']??0); $level=max(1,(int)($_REQUEST['expected_level']??1));
...
if($_SERVER['REQUEST_METHOD']==='POST'){
  try{
    $selected=array_map('intval',$_POST['selected']??[]); $weights=$_POST['weight']??[];
